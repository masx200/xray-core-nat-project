...
Introducing ProtoBuf is an innovation, which will be explained in detail later.
...
Encryption supports two types of forms. One type is completely independent and
