...
When a Web server receives a request, it looks at the host header to direct the
...
Delete `/etc/nginx/conf.d/default.conf` and create
...
::: tip It is recommended to install Caddy through the official website
